 ...
 *
 */
class Placement_students extends CI_Model {
...
public function profileview($username)
	...
	{
		$query = $this->db->get('students');
		$query = $this->db->get_where('students', array('valid' => 0));
		return $query->result_array();
	}
 ...
 public function recover($value)
	...
	public function register() {
		...
		$data = array('name' => $name, 'username' => $username, 'email' => $email, 'password' => $password,'branch'=>$branch, 'admnno' => $admnno, 'regno' => $regno, 'year_pass' => $year_pass,'valid'=>'1');
