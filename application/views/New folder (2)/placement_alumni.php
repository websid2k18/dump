            ...
            <div id="container_id" class="col-md-9">
                 <div class="home_steps well text-justify noborder">
                   ...
                   <?php $this->load->helper('form');
                    ...
                    echo form_open('/placement/alumni_register', array('class' => 'form-register ', 'role' => 'form')); ?>
                    <div class="responsive-table">
                        <table class="table table-condensed text-left">
                            <tr>
                                <h3 class="form-signin-heading margin_bottom_30">View Alumni's</h3>
                            </tr>
                            <tr>
                                <br>
                                <br>
                            ...
                            <td>
                                <select class="form-control margin_bottom_10" name="org" required>
                                                                 
                                    <?php  foreach ( $branch_details as $branch_): ?>
                                        <option class="form-control margin_bottom_10" value="<?php  echo $branch_['id'];?>"  <?php echo set_value('org')==$branch_['id'] ?  'selected="selected"' : ''  ; ?> ><?php  echo $branch_['name'];?></option>
                                        <?php endforeach ?>
                                </select>
                ...
                <div class="home_steps well text-justify noborder">
                    ...
                    <div class="responsive-table">
                        <table class="table table-condensed text-left">
                            <tr>
                                <h3 class="form-signin-heading margin_bottom_30">Register Now</h3>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input class="form-control margin_bottom_10" name="email" placeholder="Email" value="<?php echo set_value('email'); ?>" required>
                                </td>
                            </tr>
                              <tr>
                                <td>
                                ...
                                <td><input class="form-control margin_bottom_10" name="phone" placeholder="Phone Number" value="<?php echo set_value('phone'); ?>" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                             ...
                             <tr>
                                ...
                                <td><input class="form-control margin_bottom_10" name="org" placeholder="Organisation" value="<?php echo set_value('org'); ?>" required >
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td><input class="form-control margin_bottom_10" name="job" placeholder="Job Title" value="<?php echo set_value('job'); ?>" required>
                                </td>
                            </tr>
                            <tr>
