        ...
        <div class="row about">
            <div id="container_id" class="col-md-9">
                ...
                <div class="home_steps well text-justify noborder">
                    ...
                    echo form_open('/placement/contact', array('class' => 'form-register ', 'role' => 'form')); ?>
                    <div class="responsive-table">
                        <table class="table table-condensed text-left">
                            <tr>
                                <h2 class="form-signin-heading margin_bottom_30">Send a message</h2>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <td><input class="form-control margin_bottom_10" name="phone" placeholder="Phone Number" value="<?php echo set_value('phone'); ?>" >
                                </td>
                            </tr>
                            <tr>
                                <td>
                             ...
                             <tr>
                                ...
                                <td><input class="form-control margin_bottom_10" name="org" placeholder="Organisation" value="<?php echo set_value('org'); ?>" >
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td><input class="form-control margin_bottom_10" name="job" placeholder="Job Title" value="<?php echo set_value('job'); ?>">
                                </td>
                            </tr>
                            <tr>
