...
<div class="right_col" role="main">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <?php if ($con->checkIsTpoF() || $con->checkIsComF() || $con->checkIsAdminF() ) {  ?>
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="status" id="statusId" class="form-control">
                                ...
                                <option value="opened" <?php echo  set_select('status', 'opened'); ?>> Opened </option>
                                <option value="finished" <?php echo  set_select('status', 'finished'); ?>> Finished </option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
