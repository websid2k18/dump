                ...
                <div class="menu_section">
                    ...
                    <ul class="nav side-menu">
                        ...
                        <li class="<?php echo ($active=="RegComF" && $active=="listComF") ? "active" :  ""; ?>">
                            <a><i class="fas fa-industry"></i>&nbsp;&nbsp;Student Management<span class="fa"><i class="fas fa-chevron-down"></i></span></a>
                            <ul class="nav child_menu">
                                <li><a href="<?= base_url('/placement/regStdF')?>"><i class="fas fa-industry"></i>&nbsp;&nbsp;Add Students</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="">
                        <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo $_SESSION['sessTpoImg']; ?>" alt=""><?php echo $_SESSION['sessTpoName']; ?>
                            <span class=" fa fa-angle-down"></span>
                        </a>
                        <ul class="dropdown-menu dropdown-usermenu pull-right">
                            <li><a href="<?= base_url('/placement/profileTpoF')?>"> Profile</a></li>
                            <li>
                                <a href="javascript:;">
